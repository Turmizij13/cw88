<?php
class Dono_PageCache_Model_Processor
{
     ...
     * @return Dono_PageCache_Model_Processor
     */
    protected function _createRequestIds()
    {
        ...
        if ($uri) {
            ...
            if (isset($_COOKIE[Dono_PageCache_Model_Cookie::COOKIE_CUSTOMER_GROUP])) {
                $uri .= '_' . $_COOKIE[Dono_PageCache_Model_Cookie::COOKIE_CUSTOMER_GROUP];
            }
            if (isset($_COOKIE[Dono_PageCache_Model_Cookie::COOKIE_CUSTOMER_LOGGED_IN])) {
                $uri .= '_' . $_COOKIE[Dono_PageCache_Model_Cookie::COOKIE_CUSTOMER_LOGGED_IN];
            }
            if (isset($_COOKIE[Dono_PageCache_Model_Cookie::CUSTOMER_SEGMENT_IDS])) {
                $uri .= '_' . $_COOKIE[Dono_PageCache_Model_Cookie::CUSTOMER_SEGMENT_IDS];
            }
            if (isset($_COOKIE[Dono_PageCache_Model_Cookie::IS_USER_ALLOWED_SAVE_COOKIE])) {
                $uri .= '_' . $_COOKIE[Dono_PageCache_Model_Cookie::IS_USER_ALLOWED_SAVE_COOKIE];
            }
    ...
    public function extractContent($content)
    {
        ...
        if (!$content && $this->isAllowed()) {
            ...
            /*
             * @var Dono_PageCache_Model_Processor_Default
             */
            ...
            if ($content) {
                ...
                if ($productId && $countLimit) {
                    Dono_PageCache_Model_Cookie::registerViewedProducts($productId, $countLimit);
                }
            }
    ...
    protected function _processContent($content)
    {
        ...
        $sessionInfo = Dono_PageCache_Model_Cache::getCacheInstance()->load($this->getSessionInfoCacheId());
        ...
        Dono_PageCache_Helper_Url::restoreSid($content, $sidCookieValue);
    ...
    protected function _processContainers(&$content)
    {
        ...
        foreach ($placeholders as $definition) {
            $placeholder = new Dono_PageCache_Model_Container_Placeholder($definition);
    ...
    public function processRequestResponse(Zend_Controller_Request_Http $request,
        ...
        if ($this->canProcessRequest($request)) {
            ...
            if ($processor && $processor->allowCache($request)) {
                 ...
                 */
                Dono_PageCache_Helper_Url::replaceSid($content);
            ...
            if (isset($_GET[Mage_Core_Model_Session_Abstract::SESSION_ID_QUERY_PARAM])) {
                Mage::getSingleton('dono_pagecache/cookie')->updateCustomerCookies();
                Mage::getModel('dono_pagecache/observer')->updateCustomerProductIndex();
    ...
    public function canProcessRequest(Zend_Controller_Request_Http $request)
    {
        ...
        if ($res) {
            ...
            unset($queryParams[Dono_PageCache_Model_Cache::REQUEST_MESSAGE_GET_PARAM]);
     ...
     *
     * @param Zend_Controller_Request_Http $request
     * @return Dono_PageCache_Model_Processor_Default
     */
    ...
    {
        Dono_PageCache_Model_Cache::getCacheInstance()->save(
    ...
    protected function _loadMetadata()
    {
        if ($this->_metaData === null) {
            $cacheMetadata = Dono_PageCache_Model_Cache::getCacheInstance()

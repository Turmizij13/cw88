<?php
class Dono_PageCache_Model_Config extends Varien_Simplexml_Config
{
     ...
     * @return Dono_PageCache_Model_Config
     */
     ...
     * @return Dono_PageCache_Model_Container_Placeholder
     */
    public function getBlockPlaceholder($block)
    {
        ...
        if (isset($this->_placeholders[$type])) {
            ...
            $placeholder = Mage::getModel('dono_pagecache/container_placeholder', $placeholder);
            return $placeholder;
        }
        return false;
    }

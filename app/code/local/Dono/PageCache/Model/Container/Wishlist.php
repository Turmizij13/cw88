 ...
 */
class Dono_PageCache_Model_Container_Wishlist extends Dono_PageCache_Model_Container_Abstract
{
    /**
    ...
    {
        return $this->_getCookieValue(Dono_PageCache_Model_Cookie::COOKIE_WISHLIST_ITEMS, '')
            . $this->_getCookieValue(Dono_PageCache_Model_Cookie::COOKIE_WISHLIST, '')
            . ($this->_getCookieValue(Dono_PageCache_Model_Cookie::COOKIE_CUSTOMER_GROUP, ''));
    }

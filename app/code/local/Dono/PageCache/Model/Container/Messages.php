 ...
 */
class Dono_PageCache_Model_Container_Messages extends Dono_PageCache_Model_Container_Abstract
{
    /**
    ...
    {
        return $this->_getCookieValue(Dono_PageCache_Model_Cookie::COOKIE_MESSAGE)
            || array_key_exists(Dono_PageCache_Model_Cache::REQUEST_MESSAGE_GET_PARAM, $_GET);
    }
    ...
    {
        Mage::getSingleton('core/cookie')->delete(Dono_PageCache_Model_Cookie::COOKIE_MESSAGE);

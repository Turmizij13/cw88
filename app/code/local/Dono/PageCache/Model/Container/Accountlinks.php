 ...
 */
class Dono_PageCache_Model_Container_Accountlinks extends Dono_PageCache_Model_Container_Customer
{
    /**
    ...
    protected function _renderBlock()
    {
        ...
        if (!$this->_getCookieValue(Dono_PageCache_Model_Cookie::COOKIE_CUSTOMER)
            || $this->_getCookieValue(Dono_PageCache_Model_Cookie::COOKIE_CUSTOMER_LOGGED_IN)
        ) {

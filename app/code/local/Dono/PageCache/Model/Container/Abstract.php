 ...
 */
abstract class Dono_PageCache_Model_Container_Abstract
{
    /**
     * @var null|Dono_PageCache_Model_Processor
     */
     ...
     * Class constructor
     *
     * @param Dono_PageCache_Model_Container_Placeholder $placeholder
     */
    ...
    public function applyWithoutApp(&$content)
    {
        ...
        $block = Dono_PageCache_Helper_Url::replaceUenc($block);
    ...
    public function applyInApp(&$content)
    {
        ...
        if (Mage::getStoreConfig(Dono_PageCache_Model_Processor::XML_PATH_CACHE_DEBUG)) {
            $debugBlock = new Dono_PageCache_Block_Debug();
    ...
    {
        return Dono_PageCache_Model_Cache::getCacheInstance()->load($id);
    }
    ...
    protected function _saveCache($data, $id, $tags = array(), $lifetime = null)
    {
        ...
        Dono_PageCache_Model_Cache::getCacheInstance()->save($data, $id, $tags, $lifetime);
        return $this;
    }
     ...
     * @return Dono_PageCache_Model_Container_Abstract
     */
    public function setProcessor(Dono_PageCache_Model_Processor $processor)
    {
    ...
    protected function _getCategoryId()
    {
        if ($this->_processor) {
            $categoryId = $this->_processor
                ->getMetadata(Dono_PageCache_Model_Processor_Category::METADATA_CATEGORY_ID);
            if ($categoryId) {
                return $categoryId;
            }
        }
        ...
        return $this->_getCookieValue(Dono_PageCache_Model_Cookie::COOKIE_CATEGORY_ID, null);
    }
    ...
    protected function _getProductId()
    {
        ...
        return $this->_processor
            ->getMetadata(Dono_PageCache_Model_Processor_Product::METADATA_PRODUCT_ID);
    }

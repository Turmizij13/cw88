 ...
 * Orders container
 */
class Dono_PageCache_Model_Container_Orders extends Dono_PageCache_Model_Container_Advanced_Abstract
{
    ...
    {
        return $this->_getCookieValue(Dono_PageCache_Model_Cookie::COOKIE_CUSTOMER, '');
    }

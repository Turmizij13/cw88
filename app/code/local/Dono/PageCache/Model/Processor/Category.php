<?php
class Dono_PageCache_Model_Processor_Category extends Dono_PageCache_Model_Processor_Default
{
    /**
    ...
    public function getPageIdInApp(Dono_PageCache_Model_Processor $processor)
    {
        ...
        Dono_PageCache_Model_Cookie::setCategoryCookieValue($queryParams);
    ...
    public function getPageIdWithoutApp(Dono_PageCache_Model_Processor $processor)
    {
        ...
        $sessionParams = Dono_PageCache_Model_Cookie::getCategoryCookieValue();
        if ($sessionParams) {
    ...
    public function allowCache(Zend_Controller_Request_Http $request)
    {
        ...
        if ($res) {
            ...
            $maxDepth = Mage::getStoreConfig(Dono_PageCache_Model_Processor::XML_PATH_ALLOWED_DEPTH);
    ...
    protected function _prepareCatalogSession()
    {
        ...
        if (empty($queryParams)) {
            $queryParams = Dono_PageCache_Model_Cookie::getCategoryCookieValue();
     ...
     *
     * @param Dono_PageCache_Model_Processor $processor
     * @return Dono_PageCache_Model_Processor_Category
     */
    protected function _updateCategoryViewedCookie(Dono_PageCache_Model_Processor $processor)
    {
        Dono_PageCache_Model_Cookie::setCategoryViewedCookieValue(

<?php
class Dono_EDM_Block_Adminhtml_Edm_Template_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('template_name',
            array(
                'header'=> Mage::helper('edm')->__('Name'),
                'index' => 'template_name',
        ));
        $this->addColumn('template_file',
            array(
                'header'=> Mage::helper('edm')->__('File'),
                'index' => 'template_file',
        ));

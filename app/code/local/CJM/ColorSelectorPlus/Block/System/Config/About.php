...
class CJM_ColorSelectorPlus_Block_System_Config_About
    ...
    implements Varien_Data_Form_Element_Renderer_Interface
{
	public function render(Varien_Data_Form_Element_Abstract $element)
	{
		...
		$ini_setting = ini_get('allow_url_fopen');
		if($ini_setting == 0) {
			return '<div style="background-color:#FAFAFA; border:1px solid #D6D6D6; margin-bottom:10px; padding:10px 5px 5px 30px;">
						<p style="font-size:10px">In order to see when updates are available and other extension information, enable "allow_url_fopen" in your PHP settings.</p>
